...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 320000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_H743ZI_STM32H743XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_U_BLOX_M8_SATELLITES_COUNT, 24);
